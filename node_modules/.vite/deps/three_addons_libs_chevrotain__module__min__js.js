...
var R = (t, e) => () => (e || (e = { exports: {} }, t(e.exports, e)), e.exports);
var Er = R((Pt) => {
  "use strict";
...
var k = R((exports, module) => {
  ...
  exports.pick = pick;
  function has(t, e) {
    return isObject(t) ? t.hasOwnProperty(e) : false;
  }
  exports.has = has;
...
var xt = R((sn, St) => {
  (function(t, e) {
    ...
    t.prototype.saveState = function() {
      ...
      this.consumeChar("/");
      for (var A = { type: "Flags", loc: { begin: this.idx, end: u.length }, global: false, ignoreCase: false, multiLine: false, unicode: false, sticky: false }; this.isRegExpFlag(); )
        switch (this.popChar()) {
          case "g":
            o(A, "global");
            break;
      ...
      switch (this.popChar()) {
        ...
        case "(":
          ...
          return this.consumeChar(")"), { type: d, value: A, loc: this.loc(u) };
      }
      c();
      ...
      switch (this.popChar()) {
        ...
        case "{":
          ...
          switch (this.popChar()) {
            ...
            case ",":
              var g;
              this.isDigit() ? (g = this.integerIncludingZero(), d = { atLeast: _, atMost: g }) : d = { atLeast: _, atMost: Infinity }, this.consumeChar("}");
              break;
          }
          if (u === true && d === void 0)
            return;
      ...
      if (!(u === true && d === void 0))
        return s(d), this.peekChar(0) === "?" ? (this.consumeChar("?"), d.greedy = false) : d.greedy = true, d.type = "Quantifier", d.loc = this.loc(A), d;
...
`:
      ...
      for (this.consumeChar("["), this.peekChar(0) === "^" && (this.consumeChar("^"), d = true); this.isClassAtom(); ) {
        var A = this.classAtom(), _ = A.type === "Character";
        if (_ && this.isRangeDash()) {
          this.consumeChar("-");
          var g = this.classAtom(), y = g.type === "Character";
          if (y) {
            if (g.value < A.value)
              throw Error("Range out of order in character class");
            u.push({ from: A.value, to: g.value });
          } else
            a(A.value, u), u.push(i("-")), a(g.value, u);
        } else
          a(A.value, u);
      }
...
var pn = R((re) => {
  ...
  var un = xt(), pe = k(), cn = Lt(), Ce = Tr(), ln = "Complement Sets are not supported for first char optimization";
  re.failedOptimizationPrefixMsg = `Unable to use "first char" lexer optimizations:
`;
  function Va(t, e) {
    e === void 0 && (e = false);
    try {
      var r = cn.getRegExpAst(t), n = Mt(r.value, {}, r.flags.ignoreCase);
      return n;
    } catch (a) {
      if (a.message === ln)
        e && pe.PRINT_WARNING("" + re.failedOptimizationPrefixMsg + ("	Unable to optimize: < " + t.toString() + ` >
...
`) + "	Please open an issue at: https://github.com/bd82/regexp-to-ast/issues" + i);
            ...
            case "Set":
              ...
              pe.forEach(o.value, function(f) {
                if (typeof f == "number")
                  ...
                  var p = f;
                  if (r === true)
                    for (var l = p.from; l <= p.to; l++)
                      bt(l, e, r);
                  else {
                    for (var l = p.from; l <= p.to && l < Ce.minOptimizationVal; l++)
                      bt(l, e, r);
                    if (p.to >= Ce.minOptimizationVal)
                      for (var m = p.from >= Ce.minOptimizationVal ? p.from : Ce.minOptimizationVal, v = p.to, u = Ce.charCodeToOptimizedIndex(m), d = Ce.charCodeToOptimizedIndex(v), A = u; A <= d; A++)
                        e[A] = A;
                  }
                }
              });
  ...
  function yr(t) {
    return t.quantifier && t.quantifier.atLeast === 0 ? true : t.value ? pe.isArray(t.value) ? pe.every(t.value, yr) : yr(t.value) : false;
  }
  var za = function(t) {
    ja(e, t);
    function e(r) {
    ...
    return e.prototype.visitChildren = function(r) {
      ...
      pe.contains(this.targetCharCodes, r.value) && (this.found = true);
  ...
  function Ha(t, e) {
    if (e instanceof RegExp) {
      var r = cn.getRegExpAst(e), n = new za(t);
...
var Tr = R((T) => {
  ...
  var dn = xt(), F = ft(), h = k(), Ye = pn(), vn = Lt(), Ae = "PATTERN";
...
`], tracer: function(g, y) {
    ...
    r("Transform Patterns", function() {
      i = false, a = h.map(n, function(g) {
        ...
        if (h.isRegExp(y)) {
          ...
          if (h.isFunction(y))
            return i = true, { exec: y };
          if (h.has(y, "exec"))
            return i = true, y;
          if (typeof y == "string") {
            if (y.length === 1)
              return y;
            var L = y.replace(/[\\^$.*+?()[\]{}|]/g, "\\$&"), se = new RegExp(L);
    ...
    r("Line Terminator Handling", function() {
      ...
      l = h.map(n, function(y) {
        ...
        if (h.has(y, "LINE_BREAKS"))
          return y.LINE_BREAKS;
        if (En(y, g) === false)
          return Ye.canMatchCharCode(g, y.PATTERN);
      }));
    });
    var m, v, u, d;
    r("Misc Mapping #2", function() {
      m = h.map(n, Ar), v = h.map(a, mn), u = h.reduce(n, function(g, y) {
        ...
        return { pattern: a[y], longerAlt: c[y], canLineTerminator: l[y], isCustom: m[y], short: v[y], group: s[y], push: f[y], pop: p[y], tokenTypeIdx: o[y], tokenType: n[y] };
      });
    });
    var A = true, _ = [];
    return e.safeMode || r("First Char Optimization", function() {
      _ = h.reduce(n, function(g, y, b) {
        if (typeof y.PATTERN == "string") {
          var L = y.PATTERN.charCodeAt(0), se = Or(L);
          Rr(g, se, d[b]);
        } else if (h.isArray(y.START_CHARS_HINT)) {
          var fe;
          h.forEach(y.START_CHARS_HINT, function(ue) {
            var Q = typeof ue == "string" ? ue.charCodeAt(0) : ue, te = Or(Q);
            fe !== te && (fe = te, Rr(g, te, d[b]));
          });
        } else if (h.isRegExp(y.PATTERN))
          if (y.PATTERN.unicode)
            A = false, e.ensureOptimizations && h.PRINT_ERROR("" + Ye.failedOptimizationPrefixMsg + ("	Unable to analyze < " + y.PATTERN.toString() + ` > pattern.
`) + `	The regexp unicode flag is not currently supported by the regexp-to-ast library.
	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNICODE_OPTIMIZE`);
          else {
            var Z = Ye.getOptimizedStartCodesIndices(y.PATTERN, e.ensureOptimizations);
            h.isEmpty(Z) && (A = false), h.forEach(Z, function(ue) {
              Rr(g, ue, d[b]);
            });
          }
        else
          e.ensureOptimizations && h.PRINT_ERROR("" + Ye.failedOptimizationPrefixMsg + ("	TokenType: <" + y.name + `> is using a custom token pattern without providing <start_chars_hint> parameter.
`) + `	This will disable the lexer's first char optimizations.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#CUSTOM_OPTIMIZE`), A = false;
      ...
      _ = h.packArray(_);
    }), { emptyGroups: u, patternIdxToConfig: d, charCodeToPatternIdxToConfig: _, hasCustom: i, canBeOptimized: A };
  }
  T.analyzeTokenTypes = Za;
  function Ja(t, e) {
    var r = [], n = yn(t);
    r = r.concat(n.errors);
    var i = _n(n.valid), a = i.valid;
    return r = r.concat(i.errors), r = r.concat(Qa(a)), r = r.concat(gn(a)), r = r.concat(An(a, e)), r = r.concat(Rn(a)), r;
  }
  T.validatePatterns = Ja;
  function Qa(t) {
    var e = [], r = h.filter(t, function(n) {
  ...
  function yn(t) {
    var e = h.filter(t, function(i) {
      ...
      return { message: "Token Type: ->" + i.name + "<- missing static 'PATTERN' property", type: F.LexerDefinitionErrorType.MISSING_PATTERN, tokenTypes: [i] };
    }), n = h.difference(t, e);
  ...
  function _n(t) {
    var e = h.filter(t, function(i) {
      ...
      return { message: "Token Type: ->" + i.name + "<- static 'PATTERN' can only be a RegExp, a Function matching the {CustomPatternMatcherFunc} type or an Object matching the {ICustomPattern} interface.", type: F.LexerDefinitionErrorType.INVALID_PATTERN, tokenTypes: [i] };
    }), n = h.difference(t, e);
    return { errors: r, valid: n };
  }
  ...
  function On(t) {
    ...
    }(dn.BaseRegExpVisitor), r = h.filter(t, function(i) {
      var a = i[Ae];
      try {
        var o = vn.getRegExpAst(a), s = new e();
	...
	See chevrotain.io/docs/guide/resolving_lexer_errors.html#ANCHORS	for details.`, type: F.LexerDefinitionErrorType.EOI_ANCHOR_FOUND, tokenTypes: [i] };
    });
    return n;
  }
  ...
  function Nn(t) {
    var e = h.filter(t, function(n) {
      ...
      return { message: "Token Type: ->" + n.name + "<- static 'PATTERN' must not match an empty string", type: F.LexerDefinitionErrorType.EMPTY_MATCH_PATTERN, tokenTypes: [n] };
    });
    return r;
  }
  ...
  function In(t) {
	...
	See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#ANCHORS	for details.`, type: F.LexerDefinitionErrorType.SOI_ANCHOR_FOUND, tokenTypes: [i] };
    });
    return n;
  }
  ...
  function kn(t) {
    var e = h.filter(t, function(n) {
      ...
      return { message: "Token Type: ->" + n.name + "<- static 'PATTERN' may NOT contain global('g') or multiline('m')", type: F.LexerDefinitionErrorType.UNSUPPORTED_FLAGS_FOUND, tokenTypes: [n] };
    });
    return r;
  }
  T.findUnsupportedFlags = kn;
  function Pn(t) {
    var e = [], r = h.map(t, function(a) {
    ...
    var n = h.filter(r, function(a) {
      ...
      return { message: "The same RegExp pattern ->" + s + "<-" + ("has been used in all of the following Token Types: " + o.join(", ") + " <-"), type: F.LexerDefinitionErrorType.DUPLICATE_PATTERNS_FOUND, tokenTypes: a };
    });
    return i;
  }
  ...
  function gn(t) {
    var e = h.filter(t, function(n) {
      ...
      return { message: "Token Type: ->" + n.name + "<- static 'GROUP' can only be Lexer.SKIPPED/Lexer.NA/A String", type: F.LexerDefinitionErrorType.INVALID_GROUP_TYPE_FOUND, tokenTypes: [n] };
    });
    return r;
  }
  ...
  function An(t, e) {
    var r = h.filter(t, function(i) {
      ...
      return { message: a, type: F.LexerDefinitionErrorType.PUSH_MODE_DOES_NOT_EXIST, tokenTypes: [i] };
    });
    return n;
  }
  T.findModesThatDoNotExist = An;
  function Rn(t) {
    var e = [], r = h.reduce(t, function(n, i, a) {
      var o = i.PATTERN;
      return o === F.Lexer.NA || (h.isString(o) ? n.push({ str: o, idx: a, tokenType: i }) : h.isRegExp(o) && no(o) && n.push({ str: o.source, idx: a, tokenType: i })), n;
    }, []);
    return h.forEach(t, function(n, i) {
      h.forEach(r, function(a) {
        var o = a.str, s = a.idx, c = a.tokenType;
        if (i < s && ro(o, n.PATTERN)) {
          var f = "Token: ->" + c.name + `<- can never be matched.
` + ("Because it appears AFTER the Token Type ->" + n.name + "<-") + `in the lexer's definition.
See https://chevrotain.io/docs/guide/resolving_lexer_errors.html#UNREACHABLE`;
          e.push({ message: f, type: F.LexerDefinitionErrorType.UNREACHABLE_PATTERN, tokenTypes: [n, c] });
        }
      });
    }), e;
  }
  ...
  function io(t, e, r) {
    var n = [];
    return h.has(t, T.DEFAULT_MODE) || n.push({ message: "A MultiMode Lexer cannot be initialized without a <" + T.DEFAULT_MODE + `> property in its definition
...
`, type: F.LexerDefinitionErrorType.MULTI_MODE_LEXER_DEFAULT_MODE_VALUE_DOES_NOT_EXIST }), h.has(t, T.MODES) && h.forEach(t.modes, function(i, a) {
      h.forEach(i, function(o, s) {
        h.isUndefined(o) && n.push({ message: "A Lexer cannot be initialized using an undefined Token Type. Mode:" + ("<" + a + "> at index: <" + s + `>
`), type: F.LexerDefinitionErrorType.LEXER_DEFINITION_CANNOT_CONTAIN_UNDEFINED });
  ...
  function ao(t, e, r) {
    var n = [], i = false, a = h.compact(h.flatten(h.mapValues(t.modes, function(c) {
      return c;
    ...
    return e && h.forEach(o, function(c) {
      var f = En(c, s);
      if (f !== false) {
        var p = Sn(c, f), l = { message: p, type: f.issue, tokenType: c };
        n.push(l);
      } else
        h.has(c, "LINE_BREAKS") ? c.LINE_BREAKS === true && (i = true) : Ye.canMatchCharCode(s, c.PATTERN) && (i = true);
  ...
  function mn(t) {
    return h.isString(t) && t.length === 1 ? t.charCodeAt(0) : false;
  }
  T.isShortPattern = mn;
  T.LineTerminatorOptimizedTester = { test: function(t) {
  ...
  function En(t, e) {
    if (h.has(t, "LINE_BREAKS"))
      return false;
    if (h.isRegExp(t.PATTERN)) {
      try {
        Ye.canMatchCharCode(e, t.PATTERN);
      } catch (r) {
        return { issue: F.LexerDefinitionErrorType.IDENTIFY_TERMINATOR, errMsg: r.message };
      }
      return false;
    } else {
      if (h.isString(t.PATTERN))
        return false;
      if (Ar(t))
        return { issue: F.LexerDefinitionErrorType.CUSTOM_LINE_BREAK };
      throw Error("non exhaustive match");
    }
  }
  function Sn(t, e) {
...
var Xe = R((N) => {
  ...
  function xn(t) {
    for (var e = V.cloneArr(t), r = t, n = true; n; ) {
      r = V.compact(V.flatten(V.map(r, function(a) {
        return a.CATEGORIES;
      })));
      var i = V.difference(r, e);
      e = e.concat(i), V.isEmpty(i) ? n = false : r = i;
    }
    return e;
  }
...
var kr = R((wt) => {
  ...
  wt.defaultLexerErrorProvider = { buildUnableToPopLexerModeMessage: function(t) {
      ...
      i === true ? (this.traceInitMaxIdent = Infinity, this.traceInitPerf = true) : typeof i == "number" && (this.traceInitMaxIdent = i, this.traceInitPerf = true), this.traceInitIndent = -1, this.TRACE_INIT("Lexer Constructor", function() {
        ...
        n.TRACE_INIT("Lexer Config handling", function() {
          if (n.config.lineTerminatorsPattern === pt.lineTerminatorsPattern)
            n.config.lineTerminatorsPattern = Ee.LineTerminatorOptimizedTester;
          else if (n.config.lineTerminatorCharacters === pt.lineTerminatorCharacters)
            throw Error(`Error: Missing <lineTerminatorCharacters> property on the Lexer config.
	For details See: https://chevrotain.io/docs/guide/resolving_lexer_errors.html#MISSING_LINE_TERM_CHARS`);
          if (r.safeMode && r.ensureOptimizations)
            throw Error('"safeMode" and "ensureOptimizations" flags are mutually exclusive.');
          n.trackStartLines = /full|onlyStart/i.test(n.config.positionTracking), n.trackEndLines = /full/i.test(n.config.positionTracking), w.isArray(e) ? (a = { modes: {} }, a.modes[Ee.DEFAULT_MODE] = w.cloneArr(e), a[Ee.DEFAULT_MODE] = Ee.DEFAULT_MODE) : (o = false, a = w.cloneObj(e));
        ...
        if (w.forEach(a.modes, function(p, l) {
          n.TRACE_INIT("Mode: <" + l + "> processing", function() {
            if (n.modes.push(l), n.config.skipValidations === false && n.TRACE_INIT("validatePatterns", function() {
              ...
              n.TRACE_INIT("analyzeTokenTypes", function() {
                m = Ee.analyzeTokenTypes(p, { lineTerminatorCharacters: n.config.lineTerminatorCharacters, positionTracking: r.positionTracking, ensureOptimizations: r.ensureOptimizations, safeMode: r.safeMode, tracer: n.TRACE_INIT.bind(n) });
...
` + f);
        ...
        w.forEach(n.lexerDefinitionWarning, function(p) {
          ...
          if (Ee.SUPPORT_STICKY ? (n.chopInput = w.IDENTITY, n.match = n.matchWithTest) : (n.updateLastIndex = w.NOOP, n.match = n.matchWithExec), o && (n.handleModes = w.NOOP), n.trackStartLines === false && (n.computeNewColumn = w.IDENTITY), n.trackEndLines === false && (n.updateTokenEndLineColumnLocation = w.NOOP), /full/i.test(n.config.positionTracking))
          ...
          var p = w.reduce(n.canModeBeOptimized, function(l, m, v) {
            return m === false && l.push(v), l;
          }, []);
          if (r.ensureOptimizations && !w.isEmpty(p))
            throw Error("Lexer Modes: < " + p.join(", ") + ` > cannot be optimized.
...
` + i);
      ...
      var n = this, i, a, o, s, c, f, p, l, m, v, u, d, A, _, g, y = e, b = y.length, L = 0, se = 0, fe = this.hasCustom ? 0 : Math.floor(e.length / 10), Z = new Array(fe), ue = [], Q = this.trackStartLines ? 1 : void 0, te = this.trackStartLines ? 1 : void 0, xe = Ee.cloneEmptyGroups(this.emptyGroups), it = this.trackStartLines, at = this.config.lineTerminatorsPattern, Ke = 0, we = [], ot = [], It = [], Qr = [];
      Object.freeze(Qr);
      var st = void 0;
      function Jr() {
        return we;
      ...
      var wa = function(J) {
        if (It.length === 1 && J.tokenType.PUSH_MODE === void 0) {
          ...
          var Ua = n.canModeBeOptimized[ze] && n.config.safeMode === false;
          ot && Ua ? st = en : st = Jr;
        }
      };
      function tn(J) {
      ...
      for (var me; L < b; ) {
        c = null;
        var rn = y.charCodeAt(L), nn = st(rn), Da = nn.length;
        for (i = 0; i < Da; i++) {
          me = nn[i];
          var De = me.pattern;
          f = null;
          var ut = me.short;
          if (ut !== false ? rn === ut && (c = De) : me.isCustom === true ? (g = De.exec(y, L, Z, xe), g !== null ? (c = g[0], g.payload !== void 0 && (f = g.payload)) : c = null) : (this.updateLastIndex(De, L), c = this.match(De, e, L)), c !== null) {
            if (s = me.longerAlt, s !== void 0) {
              var fr = we[s], pr = fr.pattern;
              p = null, fr.isCustom === true ? (g = pr.exec(y, L, Z, xe), g !== null ? (o = g[0], g.payload !== void 0 && (p = g.payload)) : o = null) : (this.updateLastIndex(pr, L), o = this.match(pr, e, L)), o && o.length > c.length && (c = o, f = p, me = fr);
            }
            break;
          }
        }
        if (c !== null) {
          if (l = c.length, m = me.group, m !== void 0 && (v = me.tokenTypeIdx, u = this.createTokenInstance(c, L, v, me.tokenType, Q, te, l), this.handlePayload(u, f), m === false ? se = this.addToken(Z, se, u) : xe[m].push(u)), e = this.chopInput(e, l), L = L + l, te = this.computeNewColumn(te, l), it === true && me.canLineTerminator === true) {
            var kt = 0, hr = void 0, dr = void 0;
            at.lastIndex = 0;
            do
              hr = at.test(c), hr === true && (dr = at.lastIndex - 1, kt++);
            while (hr === true);
            kt !== 0 && (Q = Q + kt, te = l - dr, this.updateTokenEndLineColumnLocation(u, m, dr, kt, Q, te, l));
          }
          this.handleModes(me, wa, tn, u);
        } else {
          for (var vr = L, an = Q, on = te, ct = false; !ct && L < b; )
            for (A = y.charCodeAt(L), e = this.chopInput(e, 1), L++, a = 0; a < Ke; a++) {
              var mr = we[a], De = mr.pattern, ut = mr.short;
              if (ut !== false ? y.charCodeAt(L) === ut && (ct = true) : mr.isCustom === true ? ct = De.exec(y, L, Z, xe) !== null : (this.updateLastIndex(De, L), ct = De.exec(e) !== null), ct === true)
                break;
            }
          d = L - vr, _ = this.config.errorMessageProvider.buildUnexpectedCharactersMessage(y, vr, d, an, on), ue.push({ offset: vr, line: an, column: on, length: d, message: _ });
        }
      }
      return this.hasCustom || (Z.length = se), { tokens: Z, groups: xe, errors: ue };
      ...
      var c, f;
      r !== void 0 && (c = n === s - 1, f = c ? -1 : 0, i === 1 && c === true || (e.endLine = a + f, e.endColumn = o - 1 + -f));
      ...
      return { image: e, startOffset: r, startLine: a, startColumn: o, tokenTypeIdx: n, tokenType: i };
    }, t.prototype.createFullToken = function(e, r, n, i, a, o, s) {
      return { image: e, startOffset: r, endOffset: r + s - 1, startLine: a, endLine: a, startColumn: o, endColumn: o + s - 1, tokenTypeIdx: n, tokenType: i };
      ...
      if (this.traceInitPerf === true) {
        ...
        var i = w.timer(r), a = i.time, o = i.value, s = a > 10 ? console.warn : console.log;
...
var Ue = R((H) => {
  ...
  function go(t) {
    var e = t.pattern, r = {};
    if (r.name = t.name, Te.isUndefined(e) || (r.PATTERN = e), Te.has(t, _o))
...
See: https://github.com/chevrotain/chevrotain/issues/564#issuecomment-349062346 for details.`;
  ...
  function Ao(t, e, r, n, i, a, o, s) {
    return { image: e, startOffset: r, endOffset: n, startLine: i, endLine: a, startColumn: o, endColumn: s, tokenTypeIdx: t.tokenTypeIdx, tokenType: t };
  }
...
var ne = R((S) => {
  ...
  var Xn = function(t) {
    ...
    function e(r) {
      var n = t.call(this, r.definition) || this;
      return n.ignoreAmbiguities = false, G.assign(n, G.pick(r, function(i) {
        return i !== void 0;
      })), n;
    }
    return e;
  ...
  var ti = function(t) {
    ...
    function e(r) {
      var n = t.call(this, r.definition) || this;
      return n.idx = 1, n.ignoreAmbiguities = false, n.hasPredicates = false, G.assign(n, G.pick(r, function(i) {
        return i !== void 0;
      })), n;
    }
    return Object.defineProperty(e.prototype, "definition", { get: function() {
  ...
  function ht(t) {
    ...
    if (t instanceof Qn)
      return { type: "RepetitionMandatoryWithSeparator", idx: t.idx, separator: ht(new Dt({ terminalType: t.separator })), definition: e(t.definition) };
    if (t instanceof ei)
      return { type: "RepetitionWithSeparator", idx: t.idx, separator: ht(new Dt({ terminalType: t.separator })), definition: e(t.definition) };
    if (t instanceof Jn)
      return { type: "Repetition", idx: t.idx, definition: e(t.definition) };
    if (t instanceof ti)
      return { type: "Alternation", idx: t.idx, definition: e(t.definition) };
    if (t instanceof Dt) {
      var r = { type: "Terminal", name: t.terminalType.name, label: Oo.tokenLabel(t.terminalType), idx: t.idx }, n = t.terminalType.PATTERN;
...
var Gt = R((Ut) => {
  ...
  Ut.RestWalker = Io;
  function ri(t, e, r) {
    var n = [new ie.Option({ definition: [new ie.Terminal({ terminalType: t.separator })].concat(t.definition) })], i = n.concat(e, r);
    return i;
  }
});
var $e = R((Wt) => {
...
var vt = R((X) => {
  ...
  function xr(t, e) {
    ...
    return r ? true : t instanceof W.Alternation ? dt.some(t.definition, function(n) {
      return xr(n, e);
    }) : t instanceof W.NonTerminal && dt.contains(e, t) ? false : t instanceof W.AbstractProduction ? (t instanceof W.NonTerminal && e.push(t), dt.every(t.definition, function(n) {
      return xr(n, e);
    })) : false;
  }
  X.isOptionalProd = xr;
  ...
  function Lo(t) {
    if (t instanceof W.NonTerminal)
      return "SUBRULE";
    if (t instanceof W.Option)
      return "OPTION";
    if (t instanceof W.Alternation)
      return "OR";
    if (t instanceof W.RepetitionMandatory)
      return "AT_LEAST_ONE";
    if (t instanceof W.RepetitionMandatoryWithSeparator)
      return "AT_LEAST_ONE_SEP";
    if (t instanceof W.RepetitionWithSeparator)
      return "MANY_SEP";
    if (t instanceof W.Repetition)
      return "MANY";
    if (t instanceof W.Terminal)
      return "CONSUME";
    throw Error("non exhaustive match");
  }
...
var Lr = R((Ne) => {
  ...
  function jt(t) {
    if (t instanceof ii.NonTerminal)
      return jt(t.referencedRule);
    if (t instanceof ii.Terminal)
      return si(t);
    if (Cr.isSequenceProd(t))
      return ai(t);
    if (Cr.isBranchingProd(t))
      return oi(t);
    throw Error("non exhaustive match");
  }
  Ne.first = jt;
  function ai(t) {
    for (var e = [], r = t.definition, n = 0, i = r.length > n, a, o = true; i && o; )
...
var pi = R((he) => {
  ...
  var Fo = Gt(), wo = Lr(), ui = k(), ci = Mr(), Do = ne(), fi = function(t) {
    bo(e, t);
    function e(r) {
      var n = t.call(this) || this;
    ...
    return e.prototype.startWalking = function() {
      ...
      var a = li(r.referencedRule, r.idx) + this.topProd.name, o = n.concat(i), s = new Do.Alternative({ definition: o }), c = wo.first(s);
      this.follows[a] = c;
    }, e;
  }(Fo.RestWalker);
...
var mt = R((Me) => {
  ...
  Me.defaultParserErrorProvider = { buildMismatchTokenMessage: function(t) {
    var e = t.expected, r = t.actual, n = t.previous, i = t.ruleName, a = Ze.hasTokenLabel(e), o = a ? "--> " + Ze.tokenLabel(e) + " <--" : "token of type --> " + e.name + " <--", s = "Expecting " + o + " but found --> '" + r.image + "' <--";
    return s;
  }, buildNotAllInputParsedMessage: function(t) {
    var e = t.firstRedundant, r = t.ruleName;
    return "Redundant input, expecting EOF but found: " + e.image;
  }, buildNoViableAltMessage: function(t) {
    var e = t.expectedPathsPerAlt, r = t.actual, n = t.previous, i = t.customUserDescription, a = t.ruleName, o = "Expecting: ", s = ye.first(r).image, c = `
but found: '` + s + "'";
    if (i)
      return o + i + c;
...
`);
    ...
    var e = t.expectedIterationPaths, r = t.actual, n = t.customUserDescription, i = t.ruleName, a = "Expecting: ", o = ye.first(r).image, s = `
but found: '` + o + "'";
    if (n)
      return a + n + s;
  ...
  Me.defaultGrammarResolverErrorProvider = { buildRuleNotFoundError: function(t, e) {
    var r = "Invalid grammar, reference to a rule which is not defined: ->" + e.nonTerminalName + `<-
inside top level rule: ->` + t.name + "<-";
    return r;
  } };
  Me.defaultGrammarValidatorErrorProvider = { buildDuplicateFoundError: function(t, e) {
    function r(p) {
      return p instanceof br.Terminal ? p.terminalType.name : p instanceof br.NonTerminal ? p.nonTerminalName : "";
    }
    var n = t.name, i = ye.first(e), a = i.idx, o = hi.getProductionDslName(i), s = r(i), c = a > 0, f = "->" + o + (c ? a : "") + "<- " + (s ? "with argument: ->" + s + "<-" : "") + `
...
and Non-Terminal names start with a lower case letter.`;
    ...
    }).join(", "), r = t.alternation.idx === 0 ? "" : t.alternation.idx, n = "Ambiguous alternatives: <" + t.ambiguityIndices.join(" ,") + `> due to common lookahead prefix
...
For Further details.`;
    ...
    var e = ye.map(t.prefixPath, function(i) {
      return Ze.tokenLabel(i);
    }).join(", "), r = t.alternation.idx === 0 ? "" : t.alternation.idx, n = "Ambiguous Alternatives Detected: <" + t.ambiguityIndices.join(" ,") + "> in <OR" + r + ">" + (" inside <" + t.topLevelRule.name + `> Rule,
`) + ("<" + e + `> may appears as a prefix path in all these alternatives.
`);
...
` + ("<OR" + t.alternation.idx + "> inside <" + t.topLevelRule.name + `> Rule.
 has ` + (t.alternation.definition.length + 1) + " alternatives.");
    ...
    var e = t.topLevelRule.name, r = Wo.map(t.leftRecursionPath, function(a) {
      return a.name;
    }), n = e + " --> " + r.concat([e]).join(" --> "), i = `Left Recursion found in grammar.
...
var Tt = R((j) => {
  ...
  var Ei = Gt(), I = k(), Ko = Lr(), O = ne(), Ti = function(t) {
    je(e, t);
    function e(r, n) {
      var i = t.call(this) || this;
    ...
    return e.prototype.startWalking = function() {
      ...
      I.isEmpty(this.ruleStack) ? (this.nextProductionName = "", this.nextProductionOccurrence = 0, this.isAtEndOfPath = true) : (this.nextProductionName = this.ruleStack.pop(), this.nextProductionOccurrence = this.occurrenceStack.pop());
    }, e;
  }(Ei.RestWalker);
  ...
  var zo = function(t) {
    ...
    return e.prototype.walkTerminal = function(r, n, i) {
      if (this.isAtEndOfPath && r.terminalType.name === this.nextTerminalName && r.idx === this.nextTerminalOccurrence && !this.found) {
        var a = n.concat(i), o = new O.Alternative({ definition: a });
  ...
  function yi(t, e, r) {
    ...
    for (; r.length < e && i < t.length; ) {
      ...
      if (s instanceof O.Option)
        ...
        var c = s.definition.concat([new O.Repetition({ definition: s.definition })]);
        return o(c);
      } else if (s instanceof O.RepetitionMandatoryWithSeparator) {
        var c = [new O.Alternative({ definition: s.definition }), new O.Repetition({ definition: [new O.Terminal({ terminalType: s.separator })].concat(s.definition) })];
        return o(c);
      } else if (s instanceof O.RepetitionWithSeparator) {
        var c = s.definition.concat([new O.Repetition({ definition: [new O.Terminal({ terminalType: s.separator })].concat(s.definition) })]);
        n = o(c);
        ...
        if (s instanceof O.Alternation)
          return I.forEach(s.definition, function(f) {
            I.isEmpty(f.definition) === false && (n = o(f.definition));
          }), n;
  ...
  function Qo(t, e, r, n) {
    var i = "EXIT_NONE_TERMINAL", a = [i], o = "EXIT_ALTERNATIVE", s = false, c = e.length, f = c - n - 1, p = [], l = [];
    for (l.push({ idx: -1, def: t, ruleStack: [], occurrenceStack: [] }); !I.isEmpty(l); ) {
      var m = l.pop();
      if (m === o) {
        s && I.last(l).idx <= f && l.pop();
        continue;
      }
      var v = m.def, u = m.idx, d = m.ruleStack, A = m.occurrenceStack;
      if (!I.isEmpty(v)) {
        var _ = v[0];
        if (_ === i) {
          var g = { idx: u, def: I.drop(v), ruleStack: I.dropRight(d), occurrenceStack: I.dropRight(A) };
          l.push(g);
        } else if (_ instanceof O.Terminal)
          if (u < c - 1) {
            var y = u + 1, b = e[y];
            if (r(b, _.terminalType)) {
              var g = { idx: y, def: I.drop(v), ruleStack: d, occurrenceStack: A };
              l.push(g);
            }
          } else if (u === c - 1)
            p.push({ nextTokenType: _.terminalType, nextTokenOccurrence: _.idx, ruleStack: d, occurrenceStack: A }), s = true;
          else
            throw Error("non exhaustive match");
          ...
          var se = I.cloneArr(A);
          se.push(_.idx);
          var g = { idx: u, def: _.definition.concat(a, I.drop(v)), ruleStack: L, occurrenceStack: se };
          l.push(g);
        } else if (_ instanceof O.Option) {
          var fe = { idx: u, def: I.drop(v), ruleStack: d, occurrenceStack: A };
          l.push(fe), l.push(o);
          var Z = { idx: u, def: _.definition.concat(I.drop(v)), ruleStack: d, occurrenceStack: A };
          l.push(Z);
        } else if (_ instanceof O.RepetitionMandatory) {
          var ue = new O.Repetition({ definition: _.definition, idx: _.idx }), Q = _.definition.concat([ue], I.drop(v)), g = { idx: u, def: Q, ruleStack: d, occurrenceStack: A };
          l.push(g);
        } else if (_ instanceof O.RepetitionMandatoryWithSeparator) {
          var te = new O.Terminal({ terminalType: _.separator }), ue = new O.Repetition({ definition: [te].concat(_.definition), idx: _.idx }), Q = _.definition.concat([ue], I.drop(v)), g = { idx: u, def: Q, ruleStack: d, occurrenceStack: A };
          l.push(g);
        } else if (_ instanceof O.RepetitionWithSeparator) {
          var fe = { idx: u, def: I.drop(v), ruleStack: d, occurrenceStack: A };
          l.push(fe), l.push(o);
          var te = new O.Terminal({ terminalType: _.separator }), xe = new O.Repetition({ definition: [te].concat(_.definition), idx: _.idx }), Q = _.definition.concat([xe], I.drop(v)), Z = { idx: u, def: Q, ruleStack: d, occurrenceStack: A };
          l.push(Z);
        } else if (_ instanceof O.Repetition) {
          var fe = { idx: u, def: I.drop(v), ruleStack: d, occurrenceStack: A };
          l.push(fe), l.push(o);
          var xe = new O.Repetition({ definition: _.definition, idx: _.idx }), Q = _.definition.concat([xe], I.drop(v)), Z = { idx: u, def: Q, ruleStack: d, occurrenceStack: A };
          l.push(Z);
        } else if (_ instanceof O.Alternation)
          for (var it = _.definition.length - 1; it >= 0; it--) {
            var at = _.definition[it], Ke = { idx: u, def: at.definition.concat(I.drop(v)), ruleStack: d, occurrenceStack: A };
            l.push(Ke), l.push(o);
          }
        else if (_ instanceof O.Alternative)
          l.push({ idx: u, def: _.definition.concat(I.drop(v)), ruleStack: d, occurrenceStack: A });
...
var yt = R((C) => {
  ...
  function ts(t) {
    if (t instanceof We.Option)
      return z.OPTION;
    if (t instanceof We.Repetition)
      return z.REPETITION;
    if (t instanceof We.RepetitionMandatory)
    ...
    if (t instanceof We.Alternation)
      return z.ALTERNATION;
    throw Error("non exhaustive match");
  }
  C.getProdType = ts;
  function rs(t, e, r, n, i, a) {
    var o = Ai(t, e, r), s = Fr(o) ? Kt.tokenStructuredMatcherNoCategories : Kt.tokenStructuredMatcher;
    return a(o, n, s, i);
  }
  C.buildLookaheadFuncForOr = rs;
  function ns(t, e, r, n, i, a) {
    var o = Ri(t, e, i, r), s = Fr(o) ? Kt.tokenStructuredMatcherNoCategories : Kt.tokenStructuredMatcher;
    return a(o[0], s, n);
  }
  C.buildLookaheadFuncForOptionalProd = ns;
  function is(t, e, r, n) {
    var i = t.length, a = D.every(t, function(c) {
    ...
    if (n && !r) {
      ...
      if (a.length === 1 && D.isEmpty(a[0].categoryMatches)) {
        ...
        var c = D.reduce(a, function(f, p, l) {
          return f[p.tokenTypeIdx] = true, D.forEach(p.categoryMatches, function(m) {
            f[m] = true;
          }), f;
        }, []);
        return function() {
          var f = this.LA(1);
          return c[f.tokenTypeIdx] === true;
        };
      }
    } else
      return function() {
  ...
  var os = function(t) {
    ...
    return e.prototype.startWalking = function() {
      ...
      return r.idx === this.targetOccurrence && this.targetProdType === n ? (this.restDef = i.concat(a), true) : false;
    ...
    for (var r = D.map(t, function(p) {
      ...
      for (var c = function(p) {
        for (var l = s[p], m = 0; m < l.length; m++) {
          var v = l[m].partialPath, u = l[m].suffixDef, d = wr(v), A = ss(i, d, p);
  ...
  function Ri(t, e, r, n) {
    var i = new Oi(t, r);
    e.accept(i);
    var a = i.result, o = new os(e, t, r), s = o.startWalking(), c = new We.Alternative({ definition: a }), f = new We.Alternative({ definition: s });
    return Dr([c, f], n);
  }
      ...
      for (var r = 0; r < t.length; r++) {
        ...
        if (n.length === e.length) {
          for (var i = 0; i < n.length; i++) {
            var a = e[i], o = n[i], s = a === o || o.categoryMatchesMap[a.tokenTypeIdx] !== void 0;
            if (s === false)
              continue e;
          }
          return true;
...
var jr = R((x) => {
  ...
  var M = k(), B = k(), Ie = ce(), Gr = vt(), Qe = yt(), cs = Tt(), _e = ne(), Wr = $e();
  function ps(t, e, r, n, i) {
    ...
    var p = fs(t, r, n), l = B.map(t, function(v) {
      return xi(v, n);
  ...
  function ls(t, e) {
    var r = new bi();
    t.accept(r);
    var n = r.allProductions, i = M.groupBy(n, Li), a = M.pick(i, function(s) {
      return s.length > 1;
    }), o = M.map(M.values(a), function(s) {
      var c = M.first(s), f = e.buildDuplicateFoundError(t, s), p = Gr.getProductionDslName(c), l = { message: f, type: Ie.ParserDefinitionErrorType.DUPLICATE_PRODUCTIONS, ruleName: t.name, dslName: p, occurrence: c.idx }, m = Mi(c);
  ...
  function ki(t, e, r, n) {
    var i = [], a = B.reduce(e, function(s, c) {
      return c.name === t.name ? s + 1 : s;
    }, 0);
    if (a > 1) {
      var o = n.buildDuplicateRuleNameError({ topLevelRule: t, grammarName: r });
      i.push({ message: o, type: Ie.ParserDefinitionErrorType.DUPLICATE_RULE_NAME, ruleName: t.name });
    }
    return i;
  }
  ...
  function hs(t, e, r) {
    var n = [], i;
    return M.contains(e, t) || (i = "Invalid rule override, rule: ->" + t + "<- cannot be overridden in the grammar: ->" + r + "<-as it is not defined in any of the super grammars ", n.push({ message: i, type: Ie.ParserDefinitionErrorType.INVALID_RULE_OVERRIDE, ruleName: t })), n;
  }
  x.validateRuleIsOverridden = hs;
  function Br(t, e, r, n) {
    n === void 0 && (n = []);
    var i = [], a = _t(e.definition);
    if (M.isEmpty(a))
      return [];
    var o = t.name, s = M.contains(a, t);
    s && i.push({ message: r.buildLeftRecursionError({ topLevelRule: t, leftRecursionPath: n }), type: Ie.ParserDefinitionErrorType.LEFT_RECURSION, ruleName: o });
    var c = M.difference(a, n.concat([t])), f = M.map(c, function(p) {
      var l = M.cloneArr(n);
  ...
  function _t(t) {
    ...
    if (r instanceof _e.NonTerminal)
      ...
      throw Error("non exhaustive match");
    var n = Gr.isOptionalProd(r), i = t.length > 1;
    if (n && i) {
      var a = M.drop(t);
  ...
  function Pi(t, e) {
    var r = new qr();
    t.accept(r);
    var n = r.alternations, i = M.reduce(n, function(a, o) {
      var s = M.dropRight(o.definition), c = M.map(s, function(f, p) {
        var l = cs.nextPossibleTokensAfter([f], [], null, 1);
        return M.isEmpty(l) ? { message: e.buildEmptyAlternationError({ topLevelRule: t, alternation: o, emptyChoiceIdx: p }), type: Ie.ParserDefinitionErrorType.NONE_LAST_EMPTY_ALT, ruleName: t.name, occurrence: o.idx, alternative: p + 1 } : null;
      });
  ...
  function Si(t, e, r) {
    ...
    var a = M.reduce(i, function(o, s) {
      var c = s.idx, f = s.maxLookahead || e, p = Qe.getLookaheadPathsForOr(c, t, f, s), l = ds(p, s, t, r), m = Fi(p, s, t, r);
      return o.concat(l, m);
    }, []);
    return a;
  }
  ...
  function xi(t, e) {
    ...
    t.accept(r);
    var n = r.alternations, i = M.reduce(n, function(a, o) {
      return o.definition.length > 255 && a.push({ message: e.buildTooManyAlternativesError({ topLevelRule: t, alternation: o }), type: Ie.ParserDefinitionErrorType.TOO_MANY_ALTS, ruleName: t.name, occurrence: o.idx }), a;
    }, []);
    return i;
  }
  ...
  function Ci(t, e, r) {
    ...
    return B.forEach(t, function(i) {
      ...
      B.forEach(o, function(s) {
        var c = Qe.getProdType(s), f = s.maxLookahead || e, p = s.idx, l = Qe.getLookaheadPathsForOptionalProd(p, i, c, f), m = l[0];
        if (B.isEmpty(B.flatten(m))) {
          var v = r.buildEmptyRepetitionError({ topLevelRule: i, repetition: s });
          n.push({ message: v, type: Ie.ParserDefinitionErrorType.NO_NON_EMPTY_LOOKAHEAD, ruleName: i.name });
        }
      });
    }), n;
  }
  ...
  function ds(t, e, r, n) {
    var i = [], a = B.reduce(t, function(s, c, f) {
      return e.definition[f].ignoreAmbiguities === true || B.forEach(c, function(p) {
        var l = [f];
        B.forEach(t, function(m, v) {
          f !== v && Qe.containsPath(m, p) && e.definition[v].ignoreAmbiguities !== true && l.push(v);
        }), l.length > 1 && !Qe.containsPath(i, p) && (i.push(p), s.push({ alts: l, path: p }));
      }), s;
    }, []), o = M.map(a, function(s) {
      var c = B.map(s.alts, function(p) {
        return p + 1;
      }), f = n.buildAlternationAmbiguityError({ topLevelRule: r, alternation: e, ambiguityIndices: c, prefixPath: s.path });
      return { message: f, type: Ie.ParserDefinitionErrorType.AMBIGUOUS_ALTS, ruleName: r.name, occurrence: e.idx, alternatives: [s.alts] };
    });
    return o;
  }
  function Fi(t, e, r, n) {
    var i = [], a = B.reduce(t, function(o, s, c) {
    ...
    return B.forEach(a, function(o) {
      ...
      if (s.ignoreAmbiguities !== true) {
        var c = o.idx, f = o.path, p = B.findAll(a, function(m) {
          return e.definition[m.idx].ignoreAmbiguities !== true && m.idx < c && Qe.isStrictPrefixOfPath(m.path, f);
        }), l = B.map(p, function(m) {
          var v = [m.idx + 1, c + 1], u = e.idx === 0 ? "" : e.idx, d = n.buildAlternationPrefixAmbiguityError({ topLevelRule: r, alternation: e, ambiguityIndices: v, prefixPath: m.path });
  ...
  function fs(t, e, r) {
    ...
    return B.forEach(t, function(a) {
      ...
      if (B.contains(i, o)) {
        ...
        n.push({ message: s, type: Ie.ParserDefinitionErrorType.CONFLICT_TOKENS_RULES_NAMESPACE, ruleName: o });
      }
    }), n;
  }
});
var Ui = R((Je) => {
  ...
  function Es(t) {
    t = Vr.defaults(t, { errMsgProvider: Di.defaultGrammarResolverErrorProvider });
    var e = {};
  ...
  function Ts(t) {
    return t = Vr.defaults(t, { errMsgProvider: Di.defaultGrammarValidatorErrorProvider }), ms.validateGrammar(t.rules, t.maxLookahead, t.tokenTypes, t.errMsgProvider, t.grammarName);
  }
...
var et = R((ae) => {
  ...
  var zt = function(t) {
    gt(e, t);
    function e(r, n) {
      var i = this.constructor, a = t.call(this, r) || this;
...
var zr = R(($) => {
  ...
  var Ht = Ue(), de = k(), Ns = et(), Is = Mr(), ks = ce();
  $.EOF_FOLLOW_KEY = {};
  ...
  var Ps = function() {
    ...
    return t.prototype.initRecoverable = function(e) {
      ...
      for (var a = this, o = this.findReSyncTokenType(), s = this.exportLexerState(), c = [], f = false, p = this.LA(1), l = this.LA(1), m = function() {
        var v = a.LA(0), u = a.errorMessageProvider.buildMismatchTokenMessage({ expected: i, actual: p, previous: v, ruleName: a.getCurrRuleFullName() }), d = new Ns.MismatchedTokenException(u, p, a.LA(0));
        ...
        if (this.tokenMatcher(l, i)) {
          ...
          this.tokenMatcher(l, o) ? f = true : (l = this.SKIP_TOKEN(), this.addToResyncTokens(l, c));
      this.importLexerState(s);
    }, t.prototype.shouldInRepetitionRecoveryBeTried = function(e, r, n) {
      return !(n === false || e === void 0 || r === void 0 || this.tokenMatcher(this.LA(1), e) || this.isBackTracking() || this.canPerformInRuleRecovery(e, this.getFollowsForInRuleRecovery(e, r)));
      ...
      if (!this.canTokenTypeBeInsertedInRecovery(e) || de.isEmpty(r))
        return false;
      var i = this.LA(1), a = de.find(r, function(o) {
      ...
      return de.map(r, function(i, a) {
        return a === 0 ? $.EOF_FOLLOW_KEY : { ruleName: e.shortRuleNameToFullName(i), idxInCallingRule: n[a], inRule: e.shortRuleNameToFullName(r[a - 1]) };
      });
    }, t.prototype.flattenFollowSet = function() {
      var e = this, r = de.map(this.buildFullFollowKeyStack(), function(n) {
    ...
    }, t.prototype.attemptInRepetitionRecovery = function(e, r, n, i, a, o, s) {
    }, t.prototype.getCurrentGrammarPath = function(e, r) {
      var n = this.getHumanReadableRuleStack(), i = de.cloneArr(this.RULE_OCCURRENCE_STACK), a = { ruleStack: n, occurrenceStack: i, lastTok: e, lastTokOccurrence: r };
      return a;
  ...
  function Vi(t, e, r, n, i, a, o) {
    var s = this.getKeyForAutomaticLookahead(n, i), c = this.firstAfterRepMap[s];
    if (c === void 0) {
      var f = this.getCurrRuleFullName(), p = this.getGAstProductions()[f], l = new a(p, i);
      c = l.startWalking(), this.firstAfterRepMap[s] = c;
    }
    var m = c.token, v = c.occurrence, u = c.isEndOfRule;
...
var zi = R((Xt) => {
  ...
  var be = yt(), ge = k(), Ki = ce(), Fe = Yt(), Ve = vt(), xs = function() {
    function t() {
    }
    return t.prototype.initLooksAhead = function(e) {
      ...
      ge.forEach(e, function(n) {
        r.TRACE_INIT(n.name + " Rule Lookahead", function() {
          var i = Ve.collectMethods(n), a = i.alternation, o = i.repetition, s = i.option, c = i.repetitionMandatory, f = i.repetitionMandatoryWithSeparator, p = i.repetitionWithSeparator;
          ge.forEach(a, function(l) {
            var m = l.idx === 0 ? "" : l.idx;
            r.TRACE_INIT("" + Ve.getProductionDslName(l) + m, function() {
              var v = be.buildLookaheadFuncForOr(l.idx, n, l.maxLookahead || r.maxLookahead, l.hasPredicates, r.dynamicTokensEnabled, r.lookAheadBuilderForAlternatives), u = Fe.getKeyForAutomaticLookahead(r.fullRuleNameToShort[n.name], Fe.OR_IDX, l.idx);
      ...
      this.TRACE_INIT("" + o + (r === 0 ? "" : r), function() {
        var c = be.buildLookaheadFuncForOptionalProd(r, e, a || s.maxLookahead, s.dynamicTokensEnabled, i, s.lookAheadBuilderForOptional), f = Fe.getKeyForAutomaticLookahead(s.fullRuleNameToShort[e.name], n, r);
...
var Hr = R((Be) => {
  ...
  function Ds(t, e) {
    ...
    return Fs.isUndefined(r) || r.configurable ? (Object.defineProperty(t, Xi, { enumerable: false, configurable: true, writable: false, value: e }), true) : false;
  }
...
`).replace(/\n/g, `
  ...
  function Qi(t, e) {
    var r = ve.map(e, function(n) {
      if (!ve.isFunction(t[n]))
        return { msg: "Missing visitor method: <" + n + "> on " + At.functionName(t.constructor) + " CST Visitor.", type: Yr.MISSING_METHOD, methodName: n };
    });
    return ve.compact(r);
  }
  ...
  function Ji(t, e) {
    var r = [];
    for (var n in t)
      ve.isFunction(t[n]) && !ve.contains(Ws, n) && !ve.contains(e, n) && r.push({ msg: "Redundant visitor method: <" + n + "> on " + At.functionName(t.constructor) + ` CST Visitor
There is no Grammar Rule corresponding to this method's name.
`, type: Yr.REDUNDANT_METHOD, methodName: n });
    return r;
  }
...
var oa = R((Qt) => {
  ...
  var aa = k(), Vs = et(), Xr = ce(), Ks = mt(), zs = jr(), Hs = ne(), Ys = function() {
    function t() {
    }
    return t.prototype.ACTION = function(e) {
      ...
      if (n === void 0 && (n = Xr.DEFAULT_RULE_CONFIG), aa.contains(this.definedRulesNames, e)) {
        var i = Ks.defaultGrammarValidatorErrorProvider.buildDuplicateRuleNameError({ topLevelRule: e, grammarName: this.className }), a = { message: i, type: Xr.ParserDefinitionErrorType.DUPLICATE_RULE_NAME, ruleName: e };
...
var la = R((Jt) => {
  ...
  var q = k(), le = Yt(), er = et(), sa = yt(), rt = Tt(), ua = ce(), Xs = zr(), ca = Ue(), Rt = Xe(), $s = Hr(), Zs = function() {
    function t() {
    }
...
Make sure that all grammar rule definitions are done before 'performSelfAnalysis' is called.`);
      var i = q.has(n, "resyncEnabled") ? n.resyncEnabled : ua.DEFAULT_RULE_CONFIG.resyncEnabled, a = q.has(n, "recoveryValueFunc") ? n.recoveryValueFunc : ua.DEFAULT_RULE_CONFIG.recoveryValueFunc, o = this.ruleShortNameIdx << le.BITS_FOR_METHOD_TYPE + le.BITS_FOR_OCCURRENCE_IDX;
      ...
      var i = this.RULE_STACK.length === 1, a = r && !this.isBackTracking() && this.recoveryEnabled;
      ...
      var i = this, a = this.getLaFuncFromCache(n), o, s;
      if (e.DEF !== void 0) {
      ...
      if (r.DEF !== void 0) {
        ...
        o = r;
      if (a.call(this) === true)
        for (var f = this.doSingleRepetition(o); a.call(this) === true && f === true; )
      ...
      var i = this, a = r.DEF, o = r.SEP, s = this.getLaFuncFromCache(n);
      if (s.call(this) === true) {
        a.call(this);
        for (var c = function() {
      ...
      if (r.DEF !== void 0) {
        ...
        o = r;
      for (var f = true; a.call(this) === true && f === true; )
        f = this.doSingleRepetition(o);
      ...
      var n = this.getKeyForAutomaticLookahead(le.OR_IDX, r), i = q.isArray(e) ? e : e.DEF, a = this.getLaFuncFromCache(n), o = a.call(this, i);
      if (o !== void 0) {
        var s = i[o];
      ...
      try {
        var a = this.LA(1);
        this.tokenMatcher(a, e) === true ? (this.consumeToken(), i = a) : this.consumeInternalError(e, a, n);
      } catch (o) {
      ...
      var i, a = this.LA(0);
      throw n !== void 0 && n.ERR_MSG ? i = n.ERR_MSG : i = this.errorMessageProvider.buildMismatchTokenMessage({ expected: e, actual: r, previous: a, ruleName: this.getCurrRuleFullName() }), this.SAVE_ERROR(new er.MismatchedTokenException(i, r, a));
      ...
      var e = this.errors, r = q.cloneArr(this.RULE_STACK);
...
var pa = R((tr) => {
  ...
  var $r = et(), Zr = k(), fa = yt(), Qs = ce(), Js = function() {
    function t() {
    }
    return t.prototype.initErrorHandler = function(e) {
      ...
      for (var i = this.getCurrRuleFullName(), a = this.getGAstProductions()[i], o = fa.getLookaheadPathsForOptionalProd(e, a, r, this.maxLookahead), s = o[0], c = [], f = 1; f <= this.maxLookahead; f++)
        c.push(this.LA(f));
      var p = this.errorMessageProvider.buildEarlyExitMessage({ expectedIterationPaths: s, actual: c, previous: this.LA(0), customUserDescription: n, ruleName: i });
      ...
      for (var n = this.getCurrRuleFullName(), i = this.getGAstProductions()[n], a = fa.getLookaheadPathsForOr(e, i, this.maxLookahead), o = [], s = 1; s <= this.maxLookahead; s++)
        o.push(this.LA(s));
      var c = this.LA(0), f = this.errorMessageProvider.buildNoViableAltMessage({ expectedPathsPerAlt: a, actual: o, previous: c, customUserDescription: r, ruleName: this.getCurrRuleFullName() });
...
var va = R((rr) => {
  ...
  var ha = Tt(), da = k(), eu = function() {
    ...
    return t.prototype.initContentAssist = function() {
      ...
      var r = da.first(e.ruleStack), n = this.getGAstProductions(), i = n[r], a = new ha.NextAfterTokenWalker(i, e).startWalking();
      return a;
    }, t;
  }();
  rr.ContentAssist = eu;
...
var Ra = R((nr) => {
  ...
  Object.freeze(ir);
  var Ta = true, ya = Math.pow(2, nu.BITS_FOR_OCCURRENCE_IDX) - 1, _a = Ea.createToken({ name: "RECORDING_PHASE_TOKEN", pattern: tu.Lexer.NA });
 ...
 inside top level rule: <` + this.recordingProdStack[0].name + ">"));
      ...
      var a = oe.peek(this.recordingProdStack), o = e.ruleName, s = new Pe.NonTerminal({ idx: r, nonTerminalName: o, referencedRule: void 0 });
 ...
 inside top level rule: <` + this.recordingProdStack[0].name + ">"));
      ...
      var a = oe.peek(this.recordingProdStack), o = new Pe.Terminal({ idx: r, terminalType: e });
      return a.definition.push(o), ga;
    }, t;
  }();
  nr.GastRecorder = ou;
  function Ot(t, e, r, n) {
    n === void 0 && (n = false), ar(r);
    var i = oe.peek(this.recordingProdStack), a = oe.isFunction(e) ? e : e.DEF, o = new t({ definition: [], idx: r });
  ...
  function au(t, e) {
    var r = this;
    ar(e);
    var n = oe.peek(this.recordingProdStack), i = oe.isArray(t) === false, a = i === false ? t : t.DEF, o = new Pe.Alternation({ definition: [], idx: e, ignoreAmbiguities: i && t.IGNORE_AMBIGUITIES === true });
    ...
    return o.hasPredicates = s, n.definition.push(o), oe.forEach(a, function(c) {
      ...
      o.definition.push(f), oe.has(c, "IGNORE_AMBIGUITIES") ? f.ignoreAmbiguities = c.IGNORE_AMBIGUITIES : oe.has(c, "GATE") && (f.ignoreAmbiguities = true), r.recordingProdStack.push(f), c.ALT.call(r), r.recordingProdStack.pop();
    }), ir;
  }
  function Aa(t) {
    return t === 0 ? "" : "" + t;
  ...
  var Oa = k(), su = ce(), uu = function() {
    ...
    return t.prototype.initPerformanceTracer = function(e) {
      ...
      if (this.traceInitPerf === true) {
        ...
        var n = new Array(this.traceInitIndent + 1).join("	");
        this.traceInitIndent < this.traceInitMaxIdent && console.log(n + "--> <" + e + ">");
        var i = Oa.timer(r), a = i.time, o = i.value, s = a > 10 ? console.warn : console.log;
        return this.traceInitIndent < this.traceInitMaxIdent && s(n + "<-- <" + e + "> time: " + a + "ms"), this.traceInitIndent--, o;
      } else
        return r();
    }, t;
...
var ce = R((U) => {
  ...
  var ee = k(), lu = pi(), Pa = Ue(), Sa = mt(), xa = Ui(), fu = zr(), pu = zi(), hu = ra(), du = ia(), vu = oa(), mu = la(), Eu = pa(), Tu = va(), yu = Ra(), _u = Na(), gu = Ia();
  ...
  var ur = function() {
    function t(e, r) {
      ...
      var n = this;
      if (n.initErrorHandler(r), n.initLexerAdapter(), n.initLooksAhead(r), n.initRecognizerEngine(e, r), n.initRecoverable(r), n.initTreeBuilder(r), n.initContentAssist(), n.initGastRecorder(r), n.initPerformanceTracer(r), ee.has(r, "ignoredIssues"))
      ...
      this.TRACE_INIT("performSelfAnalysis", function() {
        ...
        e.TRACE_INIT("toFastProps", function() {
          ...
          try {
            e.enableRecording(), ee.forEach(e.definedRulesNames, function(a) {
              var o = e[a], s = o.originalGrammarAction, c = void 0;
        ...
        if (e.TRACE_INIT("Grammar Resolving", function() {
          ...
          if (ee.isEmpty(i) && e.skipValidations === false) {
            var a = xa.validateGrammar({ rules: ee.values(e.gastProductionsCache), maxLookahead: e.maxLookahead, tokenTypes: ee.values(e.tokensMap), errMsgProvider: Sa.defaultGrammarValidatorErrorProvider, grammarName: n });
          ...
          throw r = ee.map(e.definitionErrors, function(a) {
            return a.message;
...
`));
  ...
  var Ou = function(t) {
    ...
    function e(r, n) {
      ...
      var i = this, a = ee.cloneObj(n);
      return a.outputCst = true, i = t.call(this, r, a) || this, i;
    }
    return e;
  }(ur);
  U.CstParser = Ou;
  var Nu = function(t) {
    ...
    function e(r, n) {
      n === void 0 && (n = U.DEFAULT_PARSER_CONFIG);
      var i = this, a = ee.cloneObj(n);
      return a.outputCst = false, i = t.call(this, r, a) || this, i;
    }
    return e;
  }(ur);
...
var La = R((cr) => {
  ...
  var Ca = Er();
  function Iu(t, e) {
    var r = e === void 0 ? {} : e, n = r.resourceBase, i = n === void 0 ? "https://unpkg.com/chevrotain@" + Ca.VERSION + "/diagrams/" : n, a = r.css, o = a === void 0 ? "https://unpkg.com/chevrotain@" + Ca.VERSION + "/diagrams/diagrams.css" : a, s = `
...
var Fa = R((E) => {
  ...
  var ku = Er();
  Object.defineProperty(E, "VERSION", { enumerable: true, get: function() {
    return ku.VERSION;
  } });
  var lr = ce();
  Object.defineProperty(E, "CstParser", { enumerable: true, get: function() {
    return lr.CstParser;
  } });
  Object.defineProperty(E, "EmbeddedActionsParser", { enumerable: true, get: function() {
    return lr.EmbeddedActionsParser;
  } });
  Object.defineProperty(E, "ParserDefinitionErrorType", { enumerable: true, get: function() {
    return lr.ParserDefinitionErrorType;
  } });
  Object.defineProperty(E, "EMPTY_ALT", { enumerable: true, get: function() {
    return lr.EMPTY_ALT;
  } });
  var Ma = ft();
  Object.defineProperty(E, "Lexer", { enumerable: true, get: function() {
    return Ma.Lexer;
  } });
  Object.defineProperty(E, "LexerDefinitionErrorType", { enumerable: true, get: function() {
    return Ma.LexerDefinitionErrorType;
  } });
  var nt = Ue();
  Object.defineProperty(E, "createToken", { enumerable: true, get: function() {
    return nt.createToken;
  } });
  Object.defineProperty(E, "createTokenInstance", { enumerable: true, get: function() {
    return nt.createTokenInstance;
  } });
  Object.defineProperty(E, "EOF", { enumerable: true, get: function() {
    return nt.EOF;
  } });
  Object.defineProperty(E, "tokenLabel", { enumerable: true, get: function() {
    return nt.tokenLabel;
  } });
  Object.defineProperty(E, "tokenMatcher", { enumerable: true, get: function() {
    return nt.tokenMatcher;
  } });
  Object.defineProperty(E, "tokenName", { enumerable: true, get: function() {
    return nt.tokenName;
  } });
  var Pu = mt();
  Object.defineProperty(E, "defaultParserErrorProvider", { enumerable: true, get: function() {
    return Pu.defaultParserErrorProvider;
  } });
  var Nt = et();
  Object.defineProperty(E, "EarlyExitException", { enumerable: true, get: function() {
    return Nt.EarlyExitException;
  } });
  Object.defineProperty(E, "isRecognitionException", { enumerable: true, get: function() {
    return Nt.isRecognitionException;
  } });
  Object.defineProperty(E, "MismatchedTokenException", { enumerable: true, get: function() {
    return Nt.MismatchedTokenException;
  } });
  Object.defineProperty(E, "NotAllInputParsedException", { enumerable: true, get: function() {
    return Nt.NotAllInputParsedException;
  } });
  Object.defineProperty(E, "NoViableAltException", { enumerable: true, get: function() {
    return Nt.NoViableAltException;
  } });
  var Su = kr();
  Object.defineProperty(E, "defaultLexerErrorProvider", { enumerable: true, get: function() {
    return Su.defaultLexerErrorProvider;
  } });
  var Se = ne();
  Object.defineProperty(E, "Alternation", { enumerable: true, get: function() {
    return Se.Alternation;
  } });
  Object.defineProperty(E, "Alternative", { enumerable: true, get: function() {
    return Se.Alternative;
  } });
  Object.defineProperty(E, "NonTerminal", { enumerable: true, get: function() {
    return Se.NonTerminal;
  } });
  Object.defineProperty(E, "Option", { enumerable: true, get: function() {
    return Se.Option;
  } });
  Object.defineProperty(E, "Repetition", { enumerable: true, get: function() {
    return Se.Repetition;
  } });
  Object.defineProperty(E, "RepetitionMandatory", { enumerable: true, get: function() {
    return Se.RepetitionMandatory;
  } });
  Object.defineProperty(E, "RepetitionMandatoryWithSeparator", { enumerable: true, get: function() {
    return Se.RepetitionMandatoryWithSeparator;
  } });
  Object.defineProperty(E, "RepetitionWithSeparator", { enumerable: true, get: function() {
    return Se.RepetitionWithSeparator;
  } });
  Object.defineProperty(E, "Rule", { enumerable: true, get: function() {
    return Se.Rule;
  } });
  Object.defineProperty(E, "Terminal", { enumerable: true, get: function() {
    return Se.Terminal;
  } });
  var ba = ne();
  Object.defineProperty(E, "serializeGrammar", { enumerable: true, get: function() {
    return ba.serializeGrammar;
  } });
  Object.defineProperty(E, "serializeProduction", { enumerable: true, get: function() {
    return ba.serializeProduction;
  } });
  var xu = $e();
  Object.defineProperty(E, "GAstVisitor", { enumerable: true, get: function() {
  ...
  E.clearCache = Cu;
  var Lu = La();
  Object.defineProperty(E, "createSyntaxDiagramsCode", { enumerable: true, get: function() {
...
export {
  chevrotain_module_min_default as default
};
...
three/examples/jsm/libs/chevrotain.module.min.js:
  (*! chevrotain - v9.0.1 *)
*/
//# sourceMappingURL=three_addons_libs_chevrotain__module__min__js.js.map
